...
<!-- ======= Header ======= -->
  <header id="header" class="header  navbaryn fixed-top d-flex align-items-center">

    <div class="d-flex align-items-center justify-content-between">
      <a href="<?= base_url('index.php') ?>" class="logo d-flex align-items-center">
        <img src="/motors/assets/img/motors.jpg" alt="">
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="<?=base_url("app/users/upload/$jsonArrayCookie[image]")?>" alt="Profile" class="rounded-circle">
            <span class="d-none d-md-block dropdown-toggle ps-2 "><?=$jsonArrayCookie['name']?></span>
